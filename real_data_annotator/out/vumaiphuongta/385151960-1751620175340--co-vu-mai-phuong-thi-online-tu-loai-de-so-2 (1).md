...
| | | | |
|---|---|---|---|
| **Question 1.** A. colonial | B. gradually | C. effortlessly | D. rapidly |
| **Question 2.** A. intelligence | B. application | C. advanced | D. recognition |
| **Question 3.** A. protective | B. personalised | C. flexible | D. publicity |
| **Question 4.** A. vulnerable | B. self-motivated | C. endangered | D. presence |
...
**1.** A cultural festival is a great way to enjoy **(10)** _______ music, dance, and food. Many people join to celebrate their **(11)** _______ and share it with others. These festivals also teach young people about their roots and help keep old customs alive in a fun and **(12)** _______ way.

| | | | |
|---|---|---|---|
| **Question 10.** A. tradition | B. traditional | C. traditionally | D. traditions |
| **Question 11.** A. historical | B. historically | C. historic | D. history |
| **Question 12.** A. excite | B. excited | C. exciting | D. excitement |
...
**2.** Many parents focus on their children's academic **(13)** _______, hoping for high scores and good schools. However, life skills such as teamwork, **(14)** _______, and problem-solving are **(15)** _______ important. A balanced **(15)** _______ should help students grow both in knowledge and in real-life abilities.

| | | | |
|---|---|---|---|
| **Question 13.** A. achieve | B. achievement | C. achievable | D. achieved |
| **Question 14.** A. depend | B. dependent | C. independence | D. dependently |
| **Question 15.** A. equalize | B. equality | C. equally | D. equal |
| **Question 16.** A. education | B. educate | C. educational | D. educationally |

**3.** Doing a part-time job as a student can be **(17)** _______, but it also brings many **(18)** _______ lessons. It teaches young people how to manage time **(19)** _______ and work with others. Through real-life experience, they can find better **(20)** _______ for their future careers. Every small task they do is a **(21)** _______ to both the workplace and their own personal growth.

| | | | |
|---|---|---|---|
| **Question 17.** A. challenge | B. challenging | C. challenger | D. challenged |
| **Question 18.** A. valuably | B. evaluate | C. value | D. valuable |
| **Question 19.** A. effective | B. effectively | C. effect | D. affect |
| **Question 20.** A. directional | B. direct | C. direction | D. directionally |
| **Question 21.** A. contribute | B. contribution | C. contributive | D. contributory |
